...
\hline
\lstinline[]$y += x;$ & \lstinline[]$y = y + x;$ \\
\lstinline[]$x -= 5;$ & \lstinline[]$x = x - 5;$ \\
\lstinline[]$x /= y;$ & \lstinline[]$x = x / y;$ \\
...
operator & description \\
\hline
\lstinline[]$++$ & increase operator \\
\lstinline[]$--$ & decrease operator
\end{tabular}
\end{table}
...
operator & description \\
\hline
\lstinline$&&$ & logical-and \\
\lstinline$||$ & logical-or \\
\lstinline$!$ & logical-not
\end{tabular}
